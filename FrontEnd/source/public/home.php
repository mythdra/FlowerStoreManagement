                        ...
                        $sql = "SELECT * FROM flower";
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo	"<div class='d-flex task-list'>
                                                        ...
                                                        <div class='task-description__heading col-xl-2 col-lg-6 col-md-6 border border-top-0 border-left-0'>
                                                            <p class='task-description e__check-font-style mb-0 p-1'><a class='text-dark' href='task_infomation.php?id=$id'> $number </a></p>
                                                        </div>
                                                        ...
                                                        <div class='task-rate__heading col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 border border-top-0 border-left-0'>
                                                            <p class='badge badge-info mb-0 p-1 e__check-font-style'>đaq</p>
                                                        </div>										
                                                    </div>";
                            }
